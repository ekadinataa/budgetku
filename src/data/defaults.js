...
export const CATEGORIES = [
  { id: 'c1', name: 'Makanan & Minum', section: 'needs', color: '#F59E0B', icon: '🍔' },
  { id: 'c2', name: 'Transport', section: 'needs', color: '#3B82F6', icon: '🚗' },
  { id: 'c3', name: 'Utilitas', section: 'needs', color: '#8B5CF6', icon: '💡' },
  { id: 'c4', name: 'Kesehatan', section: 'needs', color: '#EF4444', icon: '💊' },
  { id: 'c5', name: 'Pendidikan', section: 'needs', color: '#06B6D4', icon: '📚' },
  { id: 'c6', name: 'Belanja Bulanan', section: 'needs', color: '#EC4899', icon: '🛒' },
  { id: 'c7', name: 'Hiburan', section: 'wants', color: '#F97316', icon: '🎮' },
  { id: 'c8', name: 'Makan di Luar', section: 'wants', color: '#EAB308', icon: '🍽️' },
  { id: 'c9', name: 'Fashion', section: 'wants', color: '#A855F7', icon: '👕' },
  { id: 'c10', name: 'Langganan', section: 'wants', color: '#14B8A6', icon: '📱' },
  { id: 'c11', name: 'Hobi', section: 'wants', color: '#64748B', icon: '🎨' },
  { id: 'c12', name: 'Dana Darurat', section: 'savings', color: '#22C55E', icon: '🛡️' },
  { id: 'c13', name: 'Investasi', section: 'savings', color: '#10B981', icon: '📈' },
  { id: 'c14', name: 'Dana Pensiun', section: 'savings', color: '#059669', icon: '🏖️' },
  { id: 'c15', name: 'Gaji', section: 'income', color: '#6366F1', icon: '💰' },
  { id: 'c16', name: 'Freelance', section: 'income', color: '#8B5CF6', icon: '💻' },
  { id: 'c17', name: 'Hasil Investasi', section: 'income', color: '#10B981', icon: '💵' },
  { id: 'c18', name: 'Lainnya', section: 'income', color: '#94A3B8', icon: '📦' },
];
